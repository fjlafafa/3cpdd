...
ReturnType = namedtuple('ReturnType',('loss','nll','ppl','bind_X','handle', 'losses'), defaults=(None, None, None, None, None, None))
...
class AverageMeter(object):
    """
    Reference: https://blog.csdn.net/u013517182/article/details/111149093
    """
    def __init__(self):
        self.reset()
