...
class CondRefineDecoder(ABModel):
    ...
    def forward(self, binder, target, surface):
        ...
        # Initial state
        # See Eq. 13, we use i plus some Linear to compute the initial sequence, so that the docking module can perform the docking. Then refine the them one-by-one. 
        ...
        # Initial fold
        # Here is the docking module. There are two stages: initialization and refinement. 
        # TODO: check out the paper to understand what he is doing.
